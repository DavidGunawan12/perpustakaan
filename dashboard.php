          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="" class="font-weight-bold" target="_blank">DvdPlayerrr</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://sites.google.com/view/pplg2024/beranda" class="nav-link text-muted" target="_blank">team</a>
                </li>
                <li class="nav-item">
